...
func NewMinHeap() *MinHeap {
	return &MinHeap{data : make([]common.E,0)}
}
//
//// 数组从0开始
//// 父亲节点对应数组下标
...
func (m *MinHeap)get(i int) common.E {
	if i < 0 || i > len(m.data){
		return nil
	}
	return m.data[i]
...
func (m *MinHeap)findTop()common.E  {
	if len(m.data) == 0{
		return nil
	}
	return m.data[0]
...
func (m * MinHeap)ExtractMin()common.E{
	e := m.findTop()
	if e == nil {
		return e
	}
